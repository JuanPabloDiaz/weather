...
This project is a responsive web application that allows users to check their local weather.

## Description 💡

This project is a local weather app that allows users to check the current weather in their location. Users can view the temperature, weather conditions, and location.

This project was built as part of the **[freeCodeCamp Front End Libraries Certification](https://www.freecodecamp.org/certification/1diazdev/front-end-development-libraries)**. The goal was to build a local weather app with React.
